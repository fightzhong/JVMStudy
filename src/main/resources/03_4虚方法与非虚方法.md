...
<img src="photos/024_字节码文件分析_非虚方法.png" />
...
- 分析
  ...
  非虚方法:
    ...
    <3> 构造方法
    <4> 私有方法
  以上四类都是非虚方法, 对于非虚方法来说, 在类加载阶段就可以将方法的符号引用(如: com/fightzhong/jvm/bytecode/TestClass5.<init>)转换为内存中的直接引用, 在编译时确定了调用者, 同
  时非虚方法的符号引用转为直接引用也叫静态解析(在类加载时就能确定, 从而解析完成) 
...
<img src="photos/025_字节码文件分析_虚方法静态分派.png" />
...
<img src="photos/026_字节码文件分析_虚方法动态分派.png" />
